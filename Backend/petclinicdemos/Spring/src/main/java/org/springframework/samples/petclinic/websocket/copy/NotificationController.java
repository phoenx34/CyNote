package org.springframework.samples.petclinic.websocket.copy;
...
//	}
	...
	{
		smtpMailSender.send("849212270@qq.com", "!!!!!!!Testing", "fuck");
//		smtpMailSender.send("SeanGordonkh@gmail.com", "!!!!!!!Testing", "fuck");
